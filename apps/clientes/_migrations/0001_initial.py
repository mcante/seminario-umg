    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sede', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='relClienteSede', to='registration.sede', verbose_name='Sede')),
            ],
            options={
